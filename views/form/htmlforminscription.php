...
<form id='formInscription' action='inscriptionTest.php' method='POST'>
...
<?php endif;?>
<input type='hidden' value='<?php echo $formaction;?>' name='action'/>
<input id='boutonInsc' type='submit' value='' name='inscription'/>
</form>
<?php if(isset($errors)) :?>
		<div id='msg'>
		<?php foreach($errors as $k=>$v):?>
			<strong><?php echo substr(ucfirst($k), 0,-2). " : " . $v;?></strong><br/>
		<?php endforeach;?>
		</div>
<?php endif;?>
<?php $htmlforminscription = ob_get_clean();?>